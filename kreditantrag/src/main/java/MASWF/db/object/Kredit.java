...
/**
 * @param kredithoehe the kredithoehe to set
 */
...
/**
 * @param rueckzahlungrate the rueckzahlungrate to set
 */
...
/**
 * @param long1 the laufzeit to set
 */
...
/**
 * @param verwendungszweck the verwendungszweck to set
 */
